...
$('table tbody tr td').each(function(i, elem) { 
    ...
    if ($(elem).attr('style') == "border-bottom:1px solid #e3e3e3; width:260px") {
        ...
        stAdd = splitAdd[0].trim(); //Street Address
...
fs.writeFileSync('aaSchedule.txt', aaMeetingArray);
...
function enterData(_meetingId, _stAdd, _title, _building, _rmAdd, _wheelchair, _notes, _weekday, _pStartTime, _pEndTime, _startHour, _startMin, _endHour, _endMin, _meetingType, _special) {
    var private = {};
