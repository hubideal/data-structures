...
var latLongData = [];
var addresses = JSON.parse(fs.readFileSync('zone10AA.json','utf8')); //converted array from week two to a json file
...
async.eachSeries(addresses, function(value, callback){ 
    ...
    fs.writeFileSync('finalZone10LatLong.json', JSON.stringify(latLongData)); //creates meetingsData into a json file
});