...
$('table tbody tr td').each(function(i, elem) { //from assignment 1
    ...
    if ($(elem).attr('style') == "border-bottom:1px solid #e3e3e3;width:350px;") {
        ...
        for (var j=2; j < (count-3); j=j+4) {       
            ...
            if (newTime[10] == "Special" || newTime[11] == "Special" || newTime[12] == "Special"|| newTime[13] == "Special" || newTime[14] == "Special" || newTime[15] == "Special") {
                    if (newTime[16] == "Young"){
                        var special = "Young People";
                        }
                    else if (newTime[16] == "Spiritual") {
                        var special = "Spiritual Workshop";
                    }
                    else if (newTime[16] == "Gay,") {
                        var special = "Lesbian, Gay, & Bisexual";
                    }
                    else if (newTime[16] == "H.I.V.") {
                        var special = "H.I.V. Positive";
                    }
                    else if (newTime[16] == "Living") {
                        var special = "Living Sober";
                    }
                    else if (newTime[16] == "First") {
                        var special = "First Step Workshop";
                    }
                    else if (newTime[16] == "Steps") {
                        var special = "Steps 1-2-3";
                    }
                    else if (newTime[16] == "Eleventh") {
                        var special = "Eleventh Step";
                    }
                    else if (newTime[16] == "Special") {
                        var special = "Special Purpose Meeting";
                    }
                    else if (newTime[16] == "Came") {
                        var special = "Came to Believe";
                    }
                    else if (newTime[16] == "As") {
                        var special = "As Bill Sees It";
                    }
                    else if (newTime[16] == "Children") {
